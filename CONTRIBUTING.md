...
Follow the [Code of Conduct](CODE_OF_CONDUCT.md). Use
...
The skeleton contains documentation and repository configuration. Validation is a
review of those files; it has no application build or test command.
