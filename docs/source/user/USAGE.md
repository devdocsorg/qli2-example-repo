...
Remove the copied `SPECIFICATION.md`, updating its index entry.
Link the [canonical specification](https://github.com/devdocsorg/qli2-example-repo/blob/main/SPECIFICATION.md)
from the new README; the specification is maintained only in the skeleton.
Keep applicable project-specific skills in the contributor area.
...
| --- | --- |
| [README.md](https://github.com/devdocsorg/qli2-example-repo/blob/main/README.md) | Project name, purpose, actual first-use steps, support channel, branch table, and file inventory. |
| [BRANCHES.md](https://github.com/devdocsorg/qli2-example-repo/blob/main/BRANCHES.md) | Each real long-lived branch, its maintenance status, and relationship to `main`. |
| [contributor guide](../contributing/CONTRIBUTING.md) | Contribution destination, real validation commands, and review process. |
| [CODEOWNERS](https://github.com/devdocsorg/qli2-example-repo/blob/main/.github/CODEOWNERS) | Visible maintainers and documentation reviewers with write access to the destination repository. |
| [SECURITY.md](https://github.com/devdocsorg/qli2-example-repo/blob/main/SECURITY.md) and [CODE_OF_CONDUCT.md](https://github.com/devdocsorg/qli2-example-repo/blob/main/CODE_OF_CONDUCT.md) | The responsible team's private reporting routes and applicable policies. |
| [LICENSE](https://github.com/devdocsorg/qli2-example-repo/blob/main/LICENSE) | The project's approved licence, retaining notices required for material you reuse. |
| [Issue templates](https://github.com/devdocsorg/qli2-example-repo/tree/main/.github/ISSUE_TEMPLATE) and [PR template](https://github.com/devdocsorg/qli2-example-repo/blob/main/.github/PULL_REQUEST_TEMPLATE/pr_template.md) | Questions suited to the project and links to its contribution and security policies. |
...
[function-documentation requirement](https://github.com/devdocsorg/qli2-example-repo/blob/main/SPECIFICATION.md#native-function-reference)
...
[.env.example](https://github.com/devdocsorg/qli2-example-repo/blob/main/.env.example) entries for environment settings, and an adjacent
...
[Required Files Checklist](https://github.com/devdocsorg/qli2-example-repo/blob/main/SPECIFICATION.md#required-files-checklist).

## Configuration reference

- [.env.example](https://github.com/devdocsorg/qli2-example-repo/blob/main/.env.example) defines no variables or loading mechanism; its comments specify the information to provide for each real setting.
- [.gitignore](https://github.com/devdocsorg/qli2-example-repo/blob/main/.gitignore) excludes `.env` and `.env.*` at any folder depth, with an exception for `.env.example`.
- [CODEOWNERS](https://github.com/devdocsorg/qli2-example-repo/blob/main/.github/CODEOWNERS) documents path matching and the actual reviewer teams inline.
...
`template=pr_template.md` to select the [template](https://github.com/devdocsorg/qli2-example-repo/blob/main/.github/PULL_REQUEST_TEMPLATE/pr_template.md).
...
to the skeleton's scope. The upstream notice is retained in [LICENSE](https://github.com/devdocsorg/qli2-example-repo/blob/main/LICENSE).
