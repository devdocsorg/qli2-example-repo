...
and command-line entry point. Every named function has a documentation comment;
...
- [`parser.ts`](parser.ts) — Parses the documented sample log format into per-task records.
